mkdir logs
CUDA_VISIBLE_DEVICES=0 python main.py --net resnet18 --dataset irish --epochs 100 --steps 50 80 --batch-size 16 --save-dir clover_res18_irish --seed 1 --lr 0.03 --num-classes 4 --pretrained imagenet > logs/logs_irish.txt
CUDA_VISIBLE_DEVICES=0 python main.py --net resnet18 --dataset irish_ext --epochs 100 --steps 50 80 --batch-size 16 --save-dir clover_res18_irish_ext --seed 1 --lr 0.03 --num-classes 4 --pretrained imagenet > logs/logs_irish_ext.txt
